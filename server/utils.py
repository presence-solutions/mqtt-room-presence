...
THREADS_POLL = concurrent.futures.ThreadPoolExecutor(
    max_workers=4, thread_name_prefix='compute_')
...
def run_in_executor(f):
    ...
    def inner(*args, **kwargs):
        ...
        return loop.run_in_executor(THREADS_POLL, lambda: f(*args, **kwargs))
